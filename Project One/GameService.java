...
public class GameService {
	...
	private static GameService service = getInstance();
	...
	public Game getGame(String name) {
		...
		while (gamesIterator.hasNext()) {
			...
			// Does game exist?
			if (gameInstance.getName().equalsIgnoreCase(name)) {
				//  Return game instance if it exists
				game = gameInstance;
			}
		}
	...
	/**
	 * Returns games that are already active
	 *
	 * @return games that are already active
	 */
